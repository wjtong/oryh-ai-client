...
import { samePrincipal, type OryhClientController, type OryhMcpClient, type SkillBundleService } from '@oryh/ai-client-core'
...
export class BusinessChat {
  ...
  /** ORYH's MCP tools, listed from the server and offered to the agent (ADR-0011). */
  readonly mcpTools:OryhMcpTools
  constructor(private ctx:Context,private controller:OryhClientController,private details:TodoDetailService,private directory:string, private api?:OryhTimesheetRemote,private projects?:OryhProjectRemote,private skills?:SkillBundleService,mcp?:OryhMcpClient){
