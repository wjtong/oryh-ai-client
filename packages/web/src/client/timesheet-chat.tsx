...
const titles={update:'修改整张工时表单',create:'填写工时表单',submit:'提交工时审批',approve:'记录审批意见','add-line':'添加工时明细','edit-line':'修改工时明细','delete-line':'删除工时明细'}
